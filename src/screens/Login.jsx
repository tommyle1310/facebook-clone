        ...
        <div className="flex flex-col w-full lg:flex-row gap-32">
            <div className="grid flex-grow flex-col gap-4 card  rounded-box">
                ...
                <div className="grid max-w-lg grid-cols-3  ">
                    <div className="card hover:scale-95 hover:duration-200 hover:cursor-pointer mt-3 mr-3   bg-base-100 shadow-xl ">
                        <figure className="">
            ...
            <div className="gap-5 flex-grow card hover:duration-200 hover:cursor-pointer bg-base-300 rounded-box p-5">
