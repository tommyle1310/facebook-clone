...
const Home = () => {
    return (
        <div className='pt-16 tw-fc gap-3 w-full md:max-w-2xl'>
            <div className="carousel join carousel-center w-full gap-3 bg-base-300 rounded-box">
                <div className="carousel-item rounded-box overflow-hidden  bg-accent tw-hv cursor-pointer tw-hv group hover:opacity-80 w-32 max-sm:w-24  ">
