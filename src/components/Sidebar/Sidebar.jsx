    ...
    return (
        <div className="fixed h-full w-80 top-16 flex flex-col p-5">
            ...
            <Link to='/saved' className="p-2 flex gap-3 items-center tw-hv hover:bg-base-300 rounded-lg">
                ...
                Saved</Link>
            <Link to='/groups' className="p-2 flex gap-3 items-center tw-hv hover:bg-base-300 rounded-lg"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
