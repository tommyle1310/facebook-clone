...
const Post = () => {
    return (
        <div className=" p-5 flex flex-col bg-base-300 rounded-box gap-2">
            ...
            <div className="max-md:text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat necessitatibus impedit ullam illum fugiat, maxime dicta esse debitis culpa reprehenderit. Aliquam mollitia maxime tenetur repudiandae, magnam modi ullam? Laudantium, nostrum!</div>
