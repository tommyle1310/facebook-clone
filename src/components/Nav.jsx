        ...
        <>
            ...
            <div className="navbar z-20 fixed top-0 mx-auto px-16 bg-base-300 max-md:hidden">
                ...
                <div className="navbar-center join">
                    <Link to='/' className={handleStyleActiveTabLink('/')}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
                        <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
                    </svg>
                    </Link>
                    <Link to='/watch' className={handleStyleActiveTabLink('/watch')}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                    ...
                    <Link to='/shop' className={handleStyleActiveTabLink('/shop')}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                    ...
                    <Link to='/groups' className={handleStyleActiveTabLink('/groups')}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 right-0">
                            ...
                            <li tabIndex={0} className="collapse p-0 border border-base-300 bg-base-200">
                                ...
                                <div className="collapse-content flex flex-col p-0">
                                    ...
                                    <div onClick={() => toggleTheme('aqua')} className="tw-hv hover:bg-base-200 w-full text-center py-2">aqua</div>
            ...
            <div className="tw-jb px-5 p-5 -mb-16 md:hidden w-full gap-5 fixed top-0 z-20 bg-base-300">
                ...
                <div className="form-control">
                    <input type="text" placeholder="Search" className="input input-bordered max-w-lg max-md:max-w-[10rem]" />
                </div>
